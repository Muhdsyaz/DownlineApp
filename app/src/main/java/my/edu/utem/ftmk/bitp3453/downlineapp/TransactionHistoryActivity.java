    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("transactions").whereEqualTo("id", id).orderBy("transactiondate", Query.Direction.DESCENDING).get()
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(TransactionHistoryActivity.this, "Fail to get the data.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                transactionRVAdapter = new TransactionRVAdapter(searchItems,TransactionHistoryActivity.this);
                rvTransactionHistory.setLayoutManager(new LinearLayoutManager(TransactionHistoryActivity.this, LinearLayoutManager.VERTICAL,false));
                rvTransactionHistory.setAdapter(transactionRVAdapter);
